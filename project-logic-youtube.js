...
$("#search").on("click", function () {
    ...
    if (artist === "") {
        ...
        // now emptying the keyword input element from one of Jeff's scripts, because
        // my script (Sydney's script) was emptying the keyword before it was getting
        // passed to Jeff's scripts
        //$("#keyword").val("");
    }
});
...
function updateSideBar() {
    ...
    // Checking to see if there's anything stored in the recent seach list before displaying it
    //if (recentSearchList.length > 0) {
